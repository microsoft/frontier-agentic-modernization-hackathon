...
# Challenge 01 – Assess the Legacy Applications
...
In this challenge you will run assessments on both legacy applications and learn to read the output critically.

## Description

Run the GitHub Copilot Modernization assessment on both sample applications:
...
For each application, review the generated assessment report and discuss as a team:

- What is the overall migration complexity rating?
- Which dependencies or APIs are flagged as unsupported or deprecated?
- What cloud-readiness issues are identified (e.g., local file system usage, MSMQ, Oracle JDBC)?
...
> **Hint:** You can run the assessment from the terminal with `modernize assess` inside each application's folder, or use the VS Code extension's "Assess" panel. Both produce the same report.
...
- Your team can articulate the **top 3 migration blockers** for each application (dependencies, APIs, or patterns that require manual attention)
- Your team has identified which modernization steps the tool can automate vs. which require manual intervention

## Learning Resources

- [Modernization assessment overview](https://learn.microsoft.com/azure/developer/github-copilot-app-modernization/modernization-agent/assess)
- [Understanding the assessment report](https://learn.microsoft.com/azure/developer/github-copilot-app-modernization/modernization-agent/assessment-report)
